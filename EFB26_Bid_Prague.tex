...
% both fundamental and strategic applied
...
% It is classified
% as an ``Alpha-{}'' global city according to GaWC studies.
...
\href{https://www.mzv.cz/jnp/en/information_for_aliens/short_stay_visa/list_of_states_whose_citizens_are/index.html}{other
  countries} might require a visa to enter the Czech Republic (see \textttt{www.mzv.cz}).
