...
\noindent
\doublespacing
\noindent{\Large Conference proposal:}
...
\bigskip\noindent
\includegraphics[width=1.0\linewidth]{Prague_foto_cut_cut}
...
as theoretical. The Heyrovský Institute of Physical Chemistry promotes
the scientific legacy of the Nobel laureate, Jaroslav Heyrovský, in a
number of fields related to physical chemistry, including atomic,
...
\item Faculty of Mathematics and Physics, Charles University
  ...
  -- less expensive and affordable without other sponsors thanks to
  expected support of the faculty (special rates on lecture halls);
  farther from the city center
  \item Congress center
    ``\href{https://www.masarykovakolej.cz/en/im-organizing-event}{Masarykova
      Kolej}'' -- more expensive but provides all services including
    lunches and accommodation in approx.~100 rooms in one building; better
...
\href{https://www.mzv.cz/jnp/en/index.html}{\texttt{www.mzv.cz}}).
